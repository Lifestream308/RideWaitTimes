      ...
      <div className='mt-2 flex flex-col gap-6 lg:gap-16 px-[6%] text-blue-900 bg-slate-100'>
        <div className='mt-6 max-w-[50rem] flex flex-col gap-12 text-2xl text-gray-500'>
          <div className='flex flex-col gap-4'>
            <h2 className='text-gray-600 text-4xl font-bold'>About Project</h2>
            ...
            <div className='w-3/5 h-1 bg-gradient-to-r from-blue-600 via-sky-300 to-yellow-400'></div>
          </div>
          <div className='flex flex-col gap-4'>
            <h2 className='text-gray-600 text-4xl font-bold'>The Frontend</h2>
          ...
          <div className='flex flex-col gap-4'>
            <h2 className='text-gray-600 text-4xl font-bold'>The Backend</h2>
