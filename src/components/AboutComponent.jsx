      ...
      <div className='mt-2 flex flex-col gap-6 lg:gap-16 px-[6%] text-blue-900'>
        <div className='mt-6 max-w-[50rem] flex flex-col gap-12 text-2xl text-gray-500'>
          <div className='flex flex-col gap-4'>
            <h2 className='text-gray-600 text-3xl font-bold'>About Project</h2>
          ...
          <div className='flex flex-col gap-4'>
            <h2 className='text-gray-600 text-3xl font-bold'>The Frontend</h2>
          ...
          <div className='flex flex-col gap-4'>
            <h2 className='text-gray-600 text-3xl font-bold'>The Backend</h2>
