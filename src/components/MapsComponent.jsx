      ...
      <div className='mt-2 flex flex-col gap-6 lg:gap-16 px-[6%] text-blue-900 bg-slate-100'>
        <div className='mt-6 max-w-[50rem] flex flex-col gap-12 text-2xl text-gray-500'>
          <div className='flex flex-col gap-4'>
            ...
            <h3 className='mt-4'>Picture maps</h3>
            <a className='mb-4 w-fit p-2 text-xl text-white bg-blue-700 rounded-lg' target='_blank' href='https://www.dreamsunlimitedtravel.com/disneyland/disneyland-map.htm'>
              Maps of Disneyland
            </a>
