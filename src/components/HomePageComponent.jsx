    ...
    <>
      <div className='mt-2'>
          <main className='flex flex-col gap-6 justify-center md:gap-16'>
            ...
            {dataNotAvailable && 
              <p className='mx-auto px-4 w-fit max-w-[50rem] text-xl text-gray-700 md:text-3xl'>Today's Disneyland ride information not available until after 8am. Below should be last night's final data.</p>
            }
