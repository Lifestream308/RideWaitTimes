  ...
  return (
    <div>
        <div className='mt-2 flex flex-col gap-8 px-[6%] bg-slate-100'>
          ...
          <button className='mt-4 px-2 py-1 w-fit text-base font-bold bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:shadow-xl hover:text-gray-200 shadow-sm shadow-neutral-600 rounded-lg sm:px-4 sm:py-2 sm:text-xl md:text-2xl' onClick={handleFilterAll}>Toggle All Rides Off</button>
